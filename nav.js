            ...
            '<div class="jslet-header-inner">' +
                    ...
                    '<div class="jslet-title-wrap jslet-dropdown" id="jslet-hub-menu">' +
                        ...
                        '<div class="jslet-hub-panel" id="jslet-hub-panel" role="menu" aria-label="Tool categories">' +
                            '<div class="jslet-hub-head">' +
                                ...
                                '<span class="jslet-hub-count">14 Categories · 113 Tools</span>' +
                            '</div>' +
                            ...
                            '</div>' +
                            '<a href="/" class="jslet-hub-all">View all 113 tools <span aria-hidden="true">→</span></a>' +
                        '</div>' +
                    '</div>' +
                ...
                '<div class="jslet-search-container">' +
                    '<div class="jslet-search-bar">' +
                        ...
                        '<input type="text" placeholder="Search 113 dev tools, calculators &amp; briefings..." id="jslet-global-search" autocomplete="off">' +
                    '</div>' +
                '</div>' +
